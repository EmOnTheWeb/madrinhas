...
<section class="where-we-work">
	<p class="where-we-work__text homepage__location-text">Though our focus is in West Africa, we sponsor students <a href="http://localhost:8888/who-do-we-support/">our mentees</a> from all over the world. We do this with the help of our <a href="http://localhost:8888/who-do-we-support/">partner charities</a></p>
